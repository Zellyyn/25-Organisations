...
AddEventHandler('esx_carteljob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'organisation_cartel', function(inventory)
...
ESX.RegisterServerCallback('esx_carteljob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'organisation_cartel', function(store)
